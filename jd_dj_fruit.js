...
const $ = new API("jd_dj_fruit");
try {
    //https://ghproxy.com/https://raw.githubusercontent.com/passerby-b/Script/master/jddj_fruit_code.js
    $.http.get({ url: 'https://raw.githubusercontent.com/Annyoo2021/scripts/main/utils/jd_dj_fruit_code.js' }).then(response => {
